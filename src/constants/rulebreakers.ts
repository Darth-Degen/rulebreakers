...
export const rulebreakers: Rulebreakers[] = [
  {
    ...
    extras:[],
    description: "Always up to no good. hangs out with his punk friends. steals cars. steals money from his mom's purse. (feels bad for it though. still a softie at heart. hence the apology flower)",
    exchange: "https://exchange.art/single/f3t6XNDzT4H1iHsSVukqCaKfCgjVos5xAYADv16djnS"
  },
  {
    id: 4,
    name:"slater",
